...
An **intrusion prevention systems**, or IPS, have all the same capabilities as an IDS, but they can do more. They *monitor system activity for intrusions and take action to stop it*.

Many tools have the ability to perform the function of both IDS and IPS. Some popular tools are *Snort*, *Zeek*, *Kismet*, *Sagan*, and *Suricata*. 
